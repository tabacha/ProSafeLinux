...
class psl:
    ...
    CMD_DHCP     = psl_typ.PslTypBoolean(0x000b,"dhcp")
    ...
    CMD_BANDWITH_INCOMMING_LIMIT= psl_typ.PslTypBandwith(0x4c00,"bandwith-in")
    CMD_BANDWITH_OUTGOING_LIMIT= psl_typ.PslTypBandwith(0x5000,"bandwith-out")
    CMD_FIXME5400= psl_typ.PslTypHex(0x5400,"fxime5400")
    CMD_BROADCAST_FILTER= psl_typ.PslTypHex(0x5800,"broadcast-filter")
    ...
    CMD_BLOCK_UNKOWN_MULTICAST= psl_typ.PslTypHex(0x6c00,"block-unknown-multicast")
